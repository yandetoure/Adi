        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="text-gray-600">
                        @if(auth()->user()->hasRole('assistant'))
                            Assistant - Gestion des catégories
                        @else
                            Administration - Gestion complète des catégories
                        @endif
                    </p>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ auth()->user()->hasRole('assistant') ? route('assistant.categories.create') : route('admin.categories.create') }}" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($categories as $category)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900">{{ $category->products_count ?? 0 }} produits</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ auth()->user()->hasRole('assistant') ? route('assistant.categories.show', $category) : route('admin.categories.show', $category) }}" 
