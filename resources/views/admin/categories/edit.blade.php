...
<div class="min-h-screen bg-gray-100">
                ...
                <div>
                    ...
                    <p class="text-gray-600">
                        @if(auth()->user()->hasRole('assistant'))
                            Assistant - Modification de la catégorie
                        @else
                            Administration - Édition de la catégorie
                        @endif
                    </p>
                </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="{{ auth()->user()->hasRole('assistant') ? route('assistant.categories.update', $category) : route('admin.categories.update', $category) }}" 
              method="POST" 
              class="space-y-8">
            @csrf
            @method('PUT')
