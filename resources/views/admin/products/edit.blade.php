...
@section('meta_description', 'Modifiez un produit existant dans la boutique ADI')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ auth()->user()->hasRole('assistant') ? route('assistant.products.index') : route('admin.products.index') }}" class="text-gray-700 hover:text-blue-600">
                        Produits
                    </a>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-500 md:ml-2">Modifier le produit</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST"
              action="{{ auth()->user()->hasRole('assistant') ? route('assistant.products.update', $product) : route('admin.products.update', $product) }}"
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">
                                Erreurs lors de la modification du produit
                            </h3>
            ...
            <div class="mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                            ...
                            <label for="main_image" class="cursor-pointer">
                                ...
                                <p class="mt-1 text-sm text-gray-600">Nouvelle image principale</p>
                        ...
                        <div id="main-image-preview" class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                            @if($product->getFirstMediaUrl('images'))
                                <img src="{{ $product->getFirstMediaUrl('images') }}" class="w-full h-32 object-cover rounded-lg">
                ...
                <div class="mb-6">
                    <label for="default_image_url" class="block text-sm font-medium text-gray-700 mb-1">URL d'image principale</label>
                    <input type="url"
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <p class="text-xs text-gray-500 mt-1">URL d'une image externe (optionnel)</p>
                ...
                <div class="mb-6">
                    ...
                    @if($product->media->count() > 0)
                        <div class="mb-4">
                            <h5 class="text-sm font-medium text-gray-700 mb-2">Images actuelles</h5>
                                ...
                                @foreach($product->media as $media)
                                    <div class="relative group">
                                        <img src="{{ $media->getUrl() }}"
                                            ...
                                            <button type="button"
                                                    onclick="deleteImage({{ $media->id }}, '{{ route('admin.products.delete-media', ['product' => $product, 'media' => $media]) }}')"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                            ...
                            <label for="secondary_images" class="cursor-pointer">
                                ...
                                <p class="mt-1 text-sm text-gray-600">Ajouter des images</p>
                                <p class="text-xs text-gray-500">PNG, JPG, GIF jusqu'à 2MB</p>
                            </label>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="mode_emploi"
                                  id="mode_emploi"
                                  rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('mode_emploi', $product->mode_emploi) }}</textarea>
                        @error('mode_emploi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="caracteristiques"
                                  id="caracteristiques"
                                  rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('caracteristiques', $product->caracteristiques) }}</textarea>
            ...
            <div class="mt-8">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="meta_description" name="meta_description" rows="3" maxlength="160"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('meta_description', $product->meta_description) }}</textarea>
...
function deleteImage(mediaId, deleteUrl) {
