    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-4">
                <a href="{{ route('admin.products.index') }}" class="hover:text-emerald-600 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                    </svg>
                </a>
                <span class="text-gray-400">/</span>
                <a href="{{ route('admin.products.index') }}" class="hover:text-emerald-600 transition-colors">Produits</a>
                <span class="text-gray-400">/</span>
...
function deleteImage(mediaId) {
    if (confirm('Êtes-vous sûr de vouloir supprimer cette image ?')) {
        fetch(`/admin/products/{{ $product->id }}/images/${mediaId}`, {
            method: 'DELETE',
            headers: {
