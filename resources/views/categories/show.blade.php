...
<nav class="bg-white py-3 border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <a href="{{ route('categories.index') }}" class="hover:text-blue-600">Catégories</a>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-6">
            ...
            <div class="w-24 h-24 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                @if($category->image)
                    <img src="{{ $category->image }}" alt="{{ $category->name }}" class="w-16 h-16 object-cover rounded-full">
                @else
            ...
            <div>
                ...
                @endif
                <p class="text-blue-200 mt-2">{{ $products->total() }} produits disponibles</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div class="w-full md:w-96">
                <form method="GET" action="{{ route('categories.show', $category) }}" class="relative">
                    <input 
                        type="text" 
                        name="search" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Aucun produit disponible dans cette catégorie pour le moment.</p>
                <div class="mt-6">
                    <a href="{{ route('categories.index') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
