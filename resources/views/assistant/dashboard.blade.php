...
<div class="min-h-screen bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="text-gray-600">Gestion des commandes, produits et catégories</p>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-500">Connecté en tant qu'Assistant</span>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Add Product -->
                <a href="{{ route('assistant.products.create') }}" class="bg-white border-2 border-blue-200 rounded-lg p-6 hover:border-blue-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                ...
                <!-- Add Category -->
                <a href="{{ route('assistant.categories.create') }}" class="bg-white border-2 border-green-200 rounded-lg p-6 hover:border-green-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                ...
                <!-- View Orders -->
                <a href="{{ route('assistant.orders.index') }}" class="bg-white border-2 border-yellow-200 rounded-lg p-6 hover:border-yellow-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                ...
                <!-- View Products -->
                <a href="{{ route('assistant.products.index') }}" class="bg-white border-2 border-blue-200 rounded-lg p-6 hover:border-blue-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                ...
                <!-- View Categories -->
                <a href="{{ route('assistant.categories.index') }}" class="bg-white border-2 border-green-200 rounded-lg p-6 hover:border-green-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                ...
                <!-- View Users -->
                <a href="{{ route('assistant.users.index') }}" class="bg-white border-2 border-purple-200 rounded-lg p-6 hover:border-purple-400 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="font-semibold text-gray-900">Voir les utilisateurs</h3>
                            <p class="text-sm text-gray-500">Consulter la liste des utilisateurs</p>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <section class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Commandes récentes</h2>
