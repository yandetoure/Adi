...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('assistant.products.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="short_description" name="short_description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('short_description') }}</textarea>
